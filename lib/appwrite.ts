...
interface AppwriteEnv {
  ...
  EXPO_PUBLIC_APPWRITE_STORE_TABLE_ID: string;
  EXPO_PUBLIC_APPWRITE_PUSH_TOKENS_TABLE_ID: string;
...
const {
  ...
  EXPO_PUBLIC_APPWRITE_STORE_TABLE_ID,
  EXPO_PUBLIC_APPWRITE_PUSH_TOKENS_TABLE_ID,
...
export const appwriteConfig = {
  ...
  storeTableId: EXPO_PUBLIC_APPWRITE_STORE_TABLE_ID,
  pushTokensTableId: EXPO_PUBLIC_APPWRITE_PUSH_TOKENS_TABLE_ID,
